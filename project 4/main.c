...
float convertToVolts(int voltBus){
	float returnVal;
	if(voltBus > 400){
		returnVal = (voltBus * 5.0)/448.0;
	}
	else if(voltBus < 140){
		returnVal = (voltBus * 5.0)/2046.0;
	}
	else if((voltBus >= 140) || (voltBus <= 200)){
		returnVal = (voltBus * 5.0)/527.0;	
	}
	else if((voltBus >= 300) || (voltBus <= 400)){
		returnVal = (voltBus * 5.0)/520.0;
	}
	else{
